...
- **Branch per group:** `phase1-a-schema`, `phase1-b-security`, `phase1-c-workflow`, `phase1-d-quality`. Never commit to `main` directly.
...
|---|---|---|---|---|
| D0 | 🔄 in-progress | (PR link TBD) | 2026-04-24 | Branch `phase1-d-quality` |
