                        ...
                        <div className="bg-white border border-ink-900/10 p-6 max-w-3xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    ...
                                    <h2 className="font-display text-2xl text-ink-900">Standard prices</h2>
                                </div>
                                <button onClick={() => setShowPriceModal(false)} className="text-slate-500 hover:text-ink-900">
                                    <X className="w-5 h-5" />
                                </button>
                            </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <FormActions align="between">
                            <p className="text-xs text-slate-500">
                                Need to add many?{" "}
                                <Link to="/add_multiple_locker" className="underline underline-offset-2 hover:text-ink-900">
