            ...
            <section className="px-6 sm:px-10 lg:px-16 py-16">
                <div className="mx-auto max-w-[1440px]">
                    ...
                    <div className="grid md:grid-cols-12 gap-8 mt-12">
                            ...
                            <div className="border border-[var(--border)] bg-[var(--surface)] p-8">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start gap-4">
                                        <Mail className="w-5 h-5 text-[var(--text)] mt-0.5" />
                                        <div>
                                            <div className="lw-label">Email</div>
                                            <p className="font-mono text-sm text-[var(--text)]">support@draconx.com</p>
                                            <p className="font-mono text-sm text-[var(--text)]">lockerwise@draconx.com</p>
                                        </div>
                                    </div>
                                    <div className="lw-rule" />
                                    <div className="flex items-start gap-4">
                                        <Phone className="w-5 h-5 text-[var(--text)] mt-0.5" />
                                        <div>
                                            <div className="lw-label">Phone</div>
                                            <p className="font-mono text-sm text-[var(--text)]">+1 (831) 216-8890</p>
                                            <p className="text-xs text-slate-500 mt-1">Mon–Fri · 9:00–18:00 EST</p>
                                        </div>
                                    </div>
                                    <div className="lw-rule" />
                                    <div className="flex items-start gap-4">
                                        <MapPin className="w-5 h-5 text-[var(--text)] mt-0.5" />
                                        <div>
                            ...
                            <div className="border border-[var(--border)] bg-[var(--surface-2)] p-8">
                                ...
                                <dl className="space-y-2 font-mono text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <dd className="text-[var(--text)]">09:00 – 18:00</dd>
                                    </div>
                                    <div className="flex justify-between">
                                        <dt className="text-slate-500">Saturday</dt>
                                        <dd className="text-[var(--text)]">10:00 – 16:00</dd>
                                    </div>
                                    <div className="flex justify-between">
                                        <dt className="text-slate-500">Sunday</dt>
                                        <dd className="text-[var(--text)]">Closed</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
                        ...
                        {/* Right column — form */}
                        <div className="md:col-span-7 border border-[var(--border)] bg-[var(--surface)] p-8 md:p-10">
                            <div className="lw-eyebrow mb-1">03 / Message</div>
                            <h2 className="font-display text-3xl text-[var(--text)] mb-8">Send us a note</h2>
                            ...
                            {submitted ? (
                                <div className="py-10 text-center">
                                    ...
                                    <h3 className="font-display text-2xl text-[var(--text)]">Message sent</h3>
                    ...
                    {/* FAQ */}
                    <div className="mt-16 border border-[var(--border)] bg-[var(--surface-2)] p-8 md:p-12">
                        <div className="lw-eyebrow mb-2">04 / FAQ</div>
                        <h2 className="font-display text-3xl text-[var(--text)] mb-8">Frequently asked</h2>
...
const Faq = ({ q, a }) => (
    <div className="border-t border-[var(--border)] pt-4">
        <h3 className="font-display text-lg text-[var(--text)]">{q}</h3>
